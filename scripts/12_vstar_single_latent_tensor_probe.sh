...
PATCHER="${ROOT_DIR}/scripts/12_make_tensor_capture_runner.py"
PY_SCRIPT="${ROOT_DIR}/scripts/12_vstar_single_latent_tensor_probe.py"
BASELINE_JSONL="${ROOT_DIR}/results/natural_trigger/vstar_n191_seed20260913.jsonl"
LOG_DIR="${ROOT_DIR}/logs"
RESULT_DIR="${ROOT_DIR}/results/latent_capture"
...
WORK_DIR="$(mktemp -d "${TMPDIR:-/tmp}/vcot_vstar_tensor.XXXXXX")"
...
python "${PATCHER}" "${WORK_DIR}/Monet_models/monet_gpu_model_runner.py"
...
LOG_FILE="${LOG_DIR}/12_vstar_single_latent_tensor_probe.log"

echo "[V_COT] Single-sample Monet latent tensor capture probe"
