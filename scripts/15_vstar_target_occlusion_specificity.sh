...
PY_SCRIPT="${ROOT_DIR}/scripts/15_vstar_target_occlusion_specificity.py"
...
RESULT_DIR="${ROOT_DIR}/results/occlusion_specificity/vstar_pos0"
...
WORK_DIR="$(mktemp -d "${TMPDIR:-/tmp}/vcot_vstar_occ_specificity.XXXXXX")"
...
LOG_FILE="${LOG_DIR}/15_vstar_target_occlusion_specificity.log"

echo "[V_COT] VStarBench position-0 full-image target-occlusion specificity pilot"
