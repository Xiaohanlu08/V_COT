...
PY_SCRIPT="${ROOT_DIR}/scripts/13_vstar_evidence_pilot.py"
BASELINE_JSONL="${ROOT_DIR}/results/natural_trigger/vstar_n191_seed20260913.jsonl"
LOG_DIR="${ROOT_DIR}/logs"
RESULT_DIR="${ROOT_DIR}/results/evidence_pilot/vstar_pos0"
...
WORK_DIR="$(mktemp -d "${TMPDIR:-/tmp}/vcot_vstar_evidence.XXXXXX")"
...
LOG_FILE="${LOG_DIR}/13_vstar_evidence_pilot.log"

echo "[V_COT] VStarBench position-0 visual-evidence latent pilot"
